...
export default function Layout({ children, currentDate }) {
  ...
  return (
    <>
      ...
      {/* Banner de sponsors - altura corregida */}
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-blue-900 to-blue-800 text-white mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center">
          <p className="text-blue-200 text-sm">
            Comprometidos con la información veraz y el desarrollo sostenible de la minería argentina
          </p>
          <p className="text-blue-100 mt-1 text-sm">Contacto: ugnoticiasmineras@gmail.com</p>
        </div>
      </footer>
    </>
  );
